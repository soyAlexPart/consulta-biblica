const bibliotecaBiblica = [
    ...
    */
    ...
    
    {
        ...
        versiculos: [
            { ref: "Salmos 37:21", texto: "21. El impío toma prestado, y no paga; Mas el justo tiene misericordia, y da." },
            { ref: "Romanos 13:8", texto: "8. No debáis a nadie nada, sino el amaros unos a otros; porque el que ama al prójimo, ha cumplido la ley." },
            { ref: "Proverbios 19:14", texto: "14. La casa y las riquezas son herencia de los padres; Mas de Jehová la mujer prudente." }
        ]
    },

    {
        ...
        versiculos: [
            { ref: "Proverbios 22:26-27", texto: "26. No seas de aquellos que se comprometen, Ni de los que salen por fiadores de deudas.\n\n27. Si no tuvieres para pagar, ¿Por qué han de quitar tu cama de debajo de ti?" },
            { ref: "Proverbios 11:15", texto: "15. Con ansiedad será afligido el que sale por fiador de un extraño; Mas el que aborreciere las fianzas vivirá seguro." },
            { ref: "Proverbios 22:7", texto: "7. El rico se enseñorea de los pobres, Y el que toma prestado es siervo del que presta." }
        ]
    },
...

{
    ...
    versiculos: [
        ...
        { 
            ref: "Juan 21:20-24",
            texto: `20. Volviéndose Pedro, vio que les seguía el discípulo a quien amaba Jesús, el mismo que en la cena se había recostado al lado de él, y le había dicho: Señor, ¿quién es el que te ha de entregar?\n
                    21. Cuando Pedro le vio, dijo a Jesús: Señor, ¿y qué de éste?\n
                    22. Jesús le dijo: <span class="letra-roja">Si quiero que él quede hasta que yo venga, ¿qué a ti? Sígueme tú.</span>\n
        ...
        {
            ref: "Juan 20:1-9",
            texto: `1. El primer día de la semana, María Magdalena fue de mañana, siendo aún oscuro, al sepulcro; y vio quitada la piedra del sepulcro.\n
...

{
    ...
    versiculos: [
        ...
        {
            ref: "Eclesiastés 7:11-12",
            texto: `11. Porque el sabio ve el día y la noche, y el necio ve el día y la noche, y no entiende nada.\n
                    12. Y en la noche, cuando los hombres se juntan para comer, y beber, y se alegran con la música, no hay que olvidar que Dios es quien da la vida a todos los hombres.\n`
        },
        {
            ref: "Eclesiastés 10:19",
            texto: `19. El que tiene grandes riquezas, no puede disfrutar de ellas; ni el que tiene muchos hijos, puede vivir de ellas.\n`
        },
        {
            ref: "Proverbios 8:12",
